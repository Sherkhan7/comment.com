            ...
            <div class="card-body">
                <form action="/user_account_edit.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control form-control-sm" type="text" name="username" id="name" value="<?= $_SESSION['username'];?>">
                            <small id="userHelp" class="form-text text-danger"><?= $usernameErr;?></small>
                        </div>

                        <div class="form-group mt-3">
                            <label for="email">Email</label>
                            <input class="form-control form-control-sm" type="text" name="email" id="email" value="<?= $_SESSION['email'];?>">
                        ...
                        <div class="avatar" style="max-width: 200px;">
                            <img src="images/<?= $user['image'];?>" alt="user_avatar" style=" border-radius: 100%;  max-width: 100%;" width="200" height="200">
                        </div>
